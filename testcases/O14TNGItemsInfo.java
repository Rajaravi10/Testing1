...
/*Launch browser method*/ 
	...
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	
	 ...
	 @DataProvider
		...
		public void ItemsInfoRond(String marchantId,String MerchantKey, String Url, String referenceNum, String CardName,
			...
			actions.Click1(driver, HPPpage.chkbx_ItemsInfo,"Show Items Info");
			...
			System.out.println("Reference of Items Info transaction: "+ref1);
...
//			System.out.println(ref);
		...
		public void afterMethod(ITestResult result) {
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","options",5,8,ref1);
