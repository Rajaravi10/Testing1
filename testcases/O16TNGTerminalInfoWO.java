...
public class O16TNGTerminalInfoWO {
	WebDriver driver ;
	...
	public void beforeMethod() {
	 ...
	 @DataProvider
	    public Object[][] dataProvi(){
			...
			Object data[][]={{marchantId,MerchantKey,Url,referenceNum,MerchTerminalID, CardAcceptorName, CardName,CardNumber,ExpMonth,ExpYear,cvv}};
			return data;
	    }
	    @Test (dataProvider = "dataProvi")
		public void TerminalInfoWORond(String marchantId,String MerchantKey,String Url,String referenceNum,String MerchTerminalID,String CardAcceptorName, String CardName,
...
//			actions.clearAndEnter(driver, HPPpage.txt_MerchCategoryCode, MerchCatCode,"MerchCategoryCode");
			...
			System.out.println("Reference of TerminalInfo WithOut MCC transaction: "+ref1);
...
//			System.out.println(ref);
		...
		public void afterMethod(ITestResult result) {
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","TermnlID",2,11,ref1);
