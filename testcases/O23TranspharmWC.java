	...
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	
	 ...
	 @DataProvider
	    public Object[][] dataProvi(){
	    	...
	    	int i=1;
	    	String marchantId = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,0);
			String MerchantKey = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,1);
			String Url = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,2);
			String Amount = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,3);
			String UserID = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,4);
			String CardName = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,5);
			String CardNumber = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,6);
			String ExpMonth = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,7);
			String ExpYear = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,8);
			String cvv = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,9);
			String password = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",i,10);
...
//	    }	 
	...
	public void TranspharmWC(String marchantId,String MerchantKey,String Url,String referenceNum,String Amount,String UserID,String CardName,
...
//			System.out.println("Reference Number for Moto transaction: "+ref);
		...
		public void afterMethod(ITestResult result) {
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","TranspWC",1,11,ref1);
