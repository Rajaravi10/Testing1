	...
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	
	 ...
	 @DataProvider
	    public Object[][] dataProvi(){
	    	...
	    	int i=1;
	    	String marchantId = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",i,0);
			String MerchantKey = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",i,1);
			String Url = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","ChSixty60",i,2);
			String Amount = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",i,3);
			String UserID = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",i,4);
//			String MerReference = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\CardsTesting.xlsx","Merchants",i,4);
			String CardName = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",i,5);
			String CardNumber = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",i,6);
			String ExpMonth = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",i,7);
			String ExpYear = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",i,8);
			String cvv = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",i,9);
			String password = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",i,10);
...
//	    }	 
	...
	public void Sixty60cnp(String marchantId,String MerchantKey,String Url,String referenceNum,String Amount,String UserID,String CardName,
...
/*getElementText*/
			Thread.sleep(4000);
//			String ref= actions.getElementText(driver, HPPpage.txt_RReference,"Response MReference");
//			System.out.println("Reference Number for Moto transaction: "+ref);
		}
	
		@AfterMethod
		public void afterMethod(ITestResult result) {
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","ChSixty60",1,11,ref1);
