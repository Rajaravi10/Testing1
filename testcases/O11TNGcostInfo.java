...
/*Launch browser method*/ 
	...
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	
	 ...
	 @DataProvider
		...
		public void CostInfoRond(String marchantId,String MerchantKey,String Url,String referenceNum, String CardName,
			...
			actions.Click1(driver, HPPpage.chkbx_CostInfo,"Show cost Info");
			...
			System.out.println("Reference of Cost Info transaction: "+ref1);
...
//			System.out.println(ref);
		...
		public void afterMethod(ITestResult result) {
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","options",2,8,ref1);
