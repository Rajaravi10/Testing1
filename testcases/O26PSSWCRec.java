	...
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	
	 ...
	 @DataProvider
	    public Object[][] dataProvi(){
	    	...
	    	int i=1;
	    	String marchantId = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,0);
			String MerchantKey = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,1);
			String Url = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,2);
			String Amount = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,3);
			String UserID = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,4);
			String CardName = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,5);
			String CardNumber = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,6);
			String ExpMonth = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,7);
			String ExpYear = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,8);
			String cvv = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,9);
			String password = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",i,10);
		...
		public void PSSWCRec(String marchantId,String MerchantKey,String Url,String referenceNum,String Amount,String UserID,String CardName,
...
/*getElementText*/
		...
		public void afterMethod(ITestResult result) {
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\ShopriteandTruworthsMerchs.xlsx","PSSWCRec",1,11,ref1);
