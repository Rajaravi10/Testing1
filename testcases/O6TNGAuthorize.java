	...
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	
	 ...
	 @DataProvider
	    public Object[][] dataProvi(){
	    	...
	    	int i=1;
	    	String marchantId = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,0);
			String MerchantKey = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,1);
			String Url = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,2);
			String Amount = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,3);
			String UserID = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,4);
			String CardName = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,5);
			String CardNumber = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,6);
			String ExpMonth = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,7);
			String ExpYear = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,8);
			String cvv = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,9);
			String password = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",i,10);
		...
		public void AuthorizeTran(String marchantId,String MerchantKey,String Url,String Amount,String UserID,String referenceNum, String CardName,
			...
			actions.ClickEleWithoutWait(driver, HPPpage.dd_Authorize, "ClickedonAuthorize");
			...
			System.out.println("Reference of Authorize transaction: "+ref1);
...
//			driver.quit();
		...
		public void afterMethod(ITestResult result) {
			...
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","Auth",1,11,ref1);
