...
/*Launch browser method*/
	...
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	
	 ...
	 @DataProvider
		...
		public void TrailsubscripRond(String marchantId,String MerchantKey,String Url,String referenceNum,String CardName,
			...
			actions.Click1(driver, HPPpage.chkbx_TrailSub,"Is Trial Subscription info");
			...
			System.out.println("Reference of Trail subscription transaction: "+ref1);
...
//			System.out.println(ref);
		...
		public void afterMethod(ITestResult result) {
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","options",6,8,ref1);
