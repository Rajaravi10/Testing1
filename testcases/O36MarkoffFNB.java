	...
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	
	 ...
	 @DataProvider
	    public Object[][] dataProvi(){
	    	...
	    	int i=1;
	    	String marchantId = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,0);
			String MerchantKey = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,1);
			String Url = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,2);
			String Amount = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,3);
			String UserID = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,4);
			String CardName = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,5);
			String CardNumber = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,6);
			String ExpMonth = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,7);
			String ExpYear = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,8);
			String cvv = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,9);
			String password = excelUtils.readDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",i,10);
		...
		public void FNBMarkoffTest(String marchantId,String MerchantKey,String Url,String referenceNum,String Amount,String UserID,String CardName,
...
//			System.out.println("Reference Number for CNP Recurring: "+ref);
		...
		public void afterMethod(ITestResult result) {
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\MarkoffTest.xlsx","FNBMer",1,11,ref1);
