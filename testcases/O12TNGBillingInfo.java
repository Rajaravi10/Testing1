...
public class O12TNGBillingInfo {
	WebDriver driver ;
...
/*Launch browser method*/ 
	...
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	
	 ...
	 @DataProvider
		...
		public void BillingInfoRond(String marchantId,String MerchantKey,String Url,String referenceNum, String CardName,
			...
			actions.Click1(driver, HPPpage.chkbx_TrailSub,"Show Billing Info");
			...
			System.out.println("Reference of Billing Info transaction: "+ref1);
...
//			System.out.println(ref);
		...
		public void afterMethod(ITestResult result) {
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","options",3,8,ref1);
