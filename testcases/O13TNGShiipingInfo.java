...
public class O13TNGShiipingInfo {
	WebDriver driver ;
...
/*Launch browser method*/
	...
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	
	 ...
	 @DataProvider
		...
		public void ShippingInfoRond(String marchantId,String MerchantKey,String Url,String referenceNum, String CardName,
			...
			actions.Click1(driver, HPPpage.chkbx_ShipInfo, "Show Shipping Info");
			...
			System.out.println("Reference of Shipping Info transaction: "+ref1);
...
//			System.out.println(ref);
		...
		public void afterMethod(ITestResult result) {
			if(result.getStatus() == ITestResult.SUCCESS) {
				excelUtils.writeDataBasedOnRowAndCell(".\\IsandoData\\IsandoDailyReport.xlsx","options",4,8,ref1);
